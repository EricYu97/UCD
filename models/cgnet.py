...
class HCGMNet(nn.Module):
    ...
    def forward(self,A,B):
        ...
        return {"aux_predictions":torch.sigmoid(change_map), "main_predictions":torch.sigmoid(final_map)}
...
class CGNet(nn.Module):
    ...
    def forward(self,A,B):
        ...
        return {"aux_predictions":change_map, "main_predictions":torch.sigmoid(final_map)}
