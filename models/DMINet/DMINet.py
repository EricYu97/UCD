...
# def draw_features(width=8,height=8,x=0,savename=0):
#     #tic=time.time()
...
class DMINet(nn.Module):
    ...
    def forward(self, imgs1, imgs2, labels=None):
        ...
        return {"main_predictions":out_2_2,"aux_predictions":[out_1, out_2, out_1_2, out_2_2]}
        # return {"main_predictions":out_2_2}
